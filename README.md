...
Read-only web dashboard for viewing [Memory Bank](https://github.com/andriispivakelectrodosg/ai-infra) project state -- core files, tasks, and lessons learned.
...
```bash
MEMORY_BANK_DIR=/path/to/memory-bank LESSONS_DIR=/path/to/lessons .venv/bin/python app.py
```

## Features

- **Sidebar navigation** -- Core Files, Tasks, Lessons Learned
...
- **Breadcrumb navigation** -- on task and lesson detail pages
